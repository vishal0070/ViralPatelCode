...
public class CustomReporter extends CustomReporterListener {
	...
	private void startResultSummaryTable(String style) {
		...
		// src='https://mbsvcsstoragephp.blob.core.windows.net/production/2020/04/MBLogo-6.png this one is for logo 

		m_out.println("<tr><td bgcolor='white' colspan='6'> <table border='0' width='100%' bgcolor='#e6f7ff'><tr>"
				+ "<td  width='25%'  bgcolor='white'>"
				+ "<center><img width='150px' src='https://mbsvcsstoragephp.blob.core.windows.net/production/2020/04/MBLogo-6.png'></center>"
				+ "</td><td ><center><font color='#008bcc'><b><h1>Automation Test Cases Analysis</h1></b></font></center></td> "
				+ "<td width='25%' bgcolor='white'>" + "<center><img width='150px' src=''/></center></td> "
				+ "</tr></table> </td></tr>");
		m_out.println("<tr><td colspan='6'>Overall test suite completion : <b>" + Time
				...
				+ MasterInit.browserName + "<t></t>" + MasterInit.browserVersion + "</b><br/>OS: <b>"
				+ System.getProperty("os.name") + "</b><br/>Tested URL: <b>" + MasterInit.testUrl
				+ "</b> <br/></td></tr>");
	...
	protected void endHtml(PrintWriter out) {
		out.println(
				"<tr bgcolor='SkyBlue'><td align='right' colspan='6'><center><b><i>Report customized by The One Technologies </i><b><center></center></b></b></center></td></tr>");
